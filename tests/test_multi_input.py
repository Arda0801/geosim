...
class TestMultiInput(unittest.TestCase):
    def test_munitions_plant_consumes_both_steel_and_fuel(self):
        ...
        w.world.add_inventory("PORT_USA", "steel", 1000)
        w.world.add_inventory("PORT_USA", "fuel", 1000)

        w.world.run_tick()

        munitions_made = w.world.get_inventory_quantity("PORT_USA", "munitions")
    ...
    def test_scarcest_input_bottlenecks_production(self):
        ...
        w.world.add_inventory("PORT_USA", "steel", 100)
        w.world.add_inventory("PORT_USA", "fuel", 1000)
        ...
        self.assertAlmostEqual(w.world.get_inventory_quantity("PORT_USA", "steel"), 0.0, places=1)
        self.assertGreater(w.world.get_inventory_quantity("PORT_USA", "fuel"), 0.0)
